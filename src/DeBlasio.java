...
//     * pair and incremenets the codon counter for that codon.
...
//    }
//
//    /* Recursive method that incremenets the count for a specific codon:
//     * If it should be at this node, incremenets it and stops,
...
//            diff += totalCount();
//            if (next != null) {
//                return next.aminoAcidCompare(inList);
//            }
...
//    }
//
//    /* Same ad above, but counts the codon useage differences
//     * Must be sorted. */
...
//            diff += totalCount();
//            if (next != null) {
//                return next.codonCompare(inList);
//            }
//
//            // need to find out if something later in *their* list matches me,
//            // but since they don't have a match in my list their total count gets added to the difference
...
//            diff += inList.totalCount();
//            if (inList.next != null) {
//                return codonCompare(inList.next);
//            }
//        }
//
//        return diff;
